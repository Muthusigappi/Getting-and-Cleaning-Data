...
## This CodeBook contains description on the data and variables in the output file generated (tidyData.txt ) based on the Study Information provided.
